...
Consumers pinning `STACK_VERSION=v5` (the common case) automatically receive minor and patch updates on their next deploy — they never see a major bump unless they change the pin themselves.
