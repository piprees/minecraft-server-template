...
class RealtimeControlsMessageTest {
    ...
    void theLocalRenderNamesItself() {
        assertEquals("message.customdimensionsclient.portal_view_client",
                RealtimeControls.messageKey(new RealtimeSettings(true, 16, true, true, false, true, true, false, false, false)));
        assertEquals("message.customdimensionsclient.portal_view_client",
                RealtimeControls.messageKey(new RealtimeSettings(true, 16, true, false, false, true, true, false, false, false)));
    }

    @Test
    void theSlabNamesItselfOnlyWhenItIsWhatTheServerWillSend() {
        assertEquals("message.customdimensionsclient.portal_view_server",
                RealtimeControls.messageKey(new RealtimeSettings(false, 16, true, true, false, true, true, false, false, false)));
        assertEquals("message.customdimensionsclient.portal_view_none",
                RealtimeControls.messageKey(new RealtimeSettings(false, 16, true, false, false, true, true, false, false, false)));
    }
}
