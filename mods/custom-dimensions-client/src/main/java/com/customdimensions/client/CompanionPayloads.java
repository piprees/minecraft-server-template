...
/**
 * The wire contract between this mod and custom-dimensions on the server.
 *
 * Both channel ids carry their version, so a server and client that disagree
 * simply never exchange the payload and each behaves as though the other were
 * vanilla. Never widen a record in place — add /v2 beside it.
 */
