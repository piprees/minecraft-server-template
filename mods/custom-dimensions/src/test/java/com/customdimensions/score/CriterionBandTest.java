...
class CriterionBandTest {
    ...
    void aCriterionWhoseQuestionIsNotADistanceHasNoBand() {
        // Of the fourteen, only three ask a distance. A fraction, a density
        // and a cliff height must stay null rather than carry an invented
        // radius the map would draw as a meaningful ring.
        ...
        assertNull(new Criteria.NothingIsImmediatelyLethal().band(def));
